          ...
          <div class="col-12">
            ...
            <div class="card">
			  ...
			  <div class="row" style="float:right;">
                 <button type="button" class="btn bg-gradient-primary m-1 createclass" data-toggle="modal" data-target="#modal-add-edit-cms"><i class="fas fa-plus-circle mr-2"></i>Add Content</button>
				 <button type="button" class="btn bg-gradient-primary m-1 createclass" data-toggle="modal" data-target="#modal-import-cms"><i class="fas fa-file-import mr-2"></i>Import Content Repo</button>
				 <button type="button" class="btn bg-gradient-primary m-1 createclass" data-toggle="modal" data-target="#modal-add-edit-class"><i class="fas fa-download mr-2"></i>Download Sample</button>
			  </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
